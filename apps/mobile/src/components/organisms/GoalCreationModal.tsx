import type { Goal, NewGoal } from "@focus-hub/shared";
...
import { isMeaningsLoadedAtom, loadMeaningsAction, meaningsAtom } from "../../stores/meaningsStore";
    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View style={styles.modalOverlay}>
        <Card style={styles.modalCard}>
          <Typography variant="h3">{editingGoal ? "Edit Goal" : "New Goal"}</Typography>
