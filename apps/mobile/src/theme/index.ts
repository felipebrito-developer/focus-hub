...
export const typography = {
	h1: { fontSize: 32, fontWeight: "700" as const, lineHeight: 44, letterSpacing: -0.5 },
	h2: { fontSize: 24, fontWeight: "700" as const, lineHeight: 36, letterSpacing: -0.2 },
	...
	label: { fontSize: 14, fontWeight: "600" as const, lineHeight: 22, letterSpacing: 0.5 }, // Wide tracking for labels
